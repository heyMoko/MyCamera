...
import com.project.mycamera.databinding.ActivityMainBinding
import com.project.mycamera.extensions.loadCenterCrop
import com.project.mycamera.util.PathUtil
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindCameraUseCase() = with(binding) {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                cameraProvider.unbindAll() // 기존의 바인딩되어 있는 카메라는 해제를 해준다.
